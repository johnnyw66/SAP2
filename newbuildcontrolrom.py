...
clLines = [
    ...
    {'key':"f0",  'alias':{'a0'},'bit':16, 'active': ACTIVEHIGH, 'desc':"JUMP condition Function bit 0 {00 -> Carry, 01 -> Non Zero, 10 -> Parity Odd, 11 --> Always}"},
...
#
    ...
    {'key':"f2",  'alias':{'Su','a2'}, 'bit':7, 'active': ACTIVEHIGH,'desc':"Select bit for Constant Bank/ALU Function"},
...
def alufunction(*args):
    ...
    control.append(decorateReadReg({'Ek','nLb'},ry))
